...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-portal-local-dev-change-in-production',
)
...
# Uso pessoal em rede local — validação de senha desativada
...
EXECUTABLES_CONFIG = BASE_DIR / 'config' / 'executables.json'
